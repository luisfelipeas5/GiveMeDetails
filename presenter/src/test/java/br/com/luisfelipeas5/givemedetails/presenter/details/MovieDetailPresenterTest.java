...
public class MovieDetailPresenterTest {
    ...
    public void setUp() {
        ...
        mMovieDetailMvpPresenter = new MovieDetailPresenter(schedulerProvider, mMovieMvpDataManager);
        mMovieDetailMvpPresenter.attach(mMovieMvpView);
    }

    @Test
    public void whenGetMovie_callDataManagerAndView_success() {
        when(mMovieMvpDataManager.getMovie(mMovieMocked.getId())).thenReturn(Single.just(mMovieMocked));
